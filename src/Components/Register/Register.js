  ...
  return (
    <section>
      ...
      <form onSubmit={handleSubmit}>
        ...
        />
        <p id="uidfirst" className={firstNameFocus && firstName && !validFistName?"instructions": "offscreen"}>
        ...
        />
        <p id="uidlast" className={lastNameFocus && lastName && !validLastName?"instructions": "offscreen"}>
          <FontAwesomeIcon icon={faInfoCircle}/>
      ...
      <label htmlFor="email">
        ...
        <button className="sign-up" disabled={!validEmail  || !validPassword ||!validMatch ? true : false}>Sign Up</button>
      </form>
      <p>
